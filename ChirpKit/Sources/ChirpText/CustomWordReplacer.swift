// Ported from MacParakeet (GPL-3.0): Sources/MacParakeetCore/TextProcessing/CustomWordReplacer.swift @ bbae9e0e
// Changes: none — direct port, `CustomWord` comes from ChirpText/Models.
...
/// full transcript *plus every word token*, so compiling per token would be
/// wasteful — this hoists compilation out of the hot loop, the same
