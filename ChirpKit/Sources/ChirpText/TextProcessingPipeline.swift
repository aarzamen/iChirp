// Ported from MacParakeet (GPL-3.0): Sources/MacParakeetCore/TextProcessing/TextProcessingPipeline.swift @ bbae9e0e
// Changes: none — direct port, `CustomWord`/`TextSnippet`/`KeyAction`/`DictationInsertionStyle`/
// `TextProcessingResult` come from ChirpText/Models.
