...
// Unchanged: the FIFO, cancellation-aware async semaphore behind `ANEInferenceGate`.
...
/// `signal()` returns a permit, waking the longest-waiting waiter first. Used
/// (via `ANEInferenceGate`) to serialize Neural Engine inference where the OS
/// requires it.
