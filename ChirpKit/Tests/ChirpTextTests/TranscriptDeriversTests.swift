// Ported from MacParakeet (GPL-3.0): Tests/MacParakeetTests/TextProcessing/TranscriptDeriversTests.swift @ bbae9e0e
// Changes: none — direct port, pure Foundation with no upstream types referenced.
