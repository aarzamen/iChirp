// Ported from MacParakeet (GPL-3.0): Tests/MacParakeetTests/TextProcessing/TextProcessingPipelineTests.swift @ bbae9e0e
// Changes: none — direct port, `CustomWord`/`TextSnippet` come from ChirpText/Models.
