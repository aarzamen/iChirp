// Ported from MacParakeet (GPL-3.0): Tests/MacParakeetTests/Services/Diarization/SpeakerMergerTests.swift @ bbae9e0e
// Changes: `SpeakerSegment` → ChirpCore's `DiarizationSegmentRecord` (same fields); `WordTimestamp`
// comes from ChirpCore.
...
final class SpeakerMergerTests: XCTestCase {
    ...
    func testTwoSpeakers() {
        ...
        let segments = [
            DiarizationSegmentRecord(speakerId: "S1", startMs: 0, endMs: 1500),
            DiarizationSegmentRecord(speakerId: "S2", startMs: 1500, endMs: 3000),
        ]
    ...
    func testPartialOverlapMostOverlapWins() {
        ...
        let segments = [
            DiarizationSegmentRecord(speakerId: "S1", startMs: 0, endMs: 600),
            DiarizationSegmentRecord(speakerId: "S2", startMs: 600, endMs: 2000),
        ]
    ...
    func testWordInGap() {
        ...
        let segments = [
            DiarizationSegmentRecord(speakerId: "S1", startMs: 0, endMs: 1000),
            DiarizationSegmentRecord(speakerId: "S2", startMs: 2500, endMs: 4000),
        ]
    ...
    func testManySpeakers() {
        ...
        let segments = [
            DiarizationSegmentRecord(speakerId: "S1", startMs: 0, endMs: 800),
            DiarizationSegmentRecord(speakerId: "S2", startMs: 800, endMs: 1800),
            DiarizationSegmentRecord(speakerId: "S3", startMs: 1800, endMs: 2800),
            DiarizationSegmentRecord(speakerId: "S4", startMs: 2800, endMs: 4000),
        ]
    ...
    func testTieBreakingEarlierSegmentWins() {
        ...
        let segments = [
            DiarizationSegmentRecord(speakerId: "S1", startMs: 0, endMs: 750),
            DiarizationSegmentRecord(speakerId: "S2", startMs: 750, endMs: 1500),
        ]
    ...
    func testIsolatedOneWordFlipInheritsNeighborSpeaker() {
        ...
        let segments = [
            DiarizationSegmentRecord(speakerId: "S1", startMs: 0, endMs: 400),
            DiarizationSegmentRecord(speakerId: "S2", startMs: 400, endMs: 480),
            DiarizationSegmentRecord(speakerId: "S1", startMs: 480, endMs: 900),
        ]
    ...
    func testTwoWordFlipIsNotSmoothed() {
        ...
        let segments = [
            DiarizationSegmentRecord(speakerId: "S1", startMs: 0, endMs: 300),
            DiarizationSegmentRecord(speakerId: "S2", startMs: 300, endMs: 900),
            DiarizationSegmentRecord(speakerId: "S1", startMs: 900, endMs: 1200),
        ]
    ...
    func testNilGapBetweenTheSameSpeakerInheritsThatSpeaker() {
        ...
        let segments = [
            DiarizationSegmentRecord(speakerId: "S1", startMs: 0, endMs: 1000),
            DiarizationSegmentRecord(speakerId: "S1", startMs: 2000, endMs: 4000),
        ]
    ...
    func testSpeakerFlipsAtTranscriptEdgesAreNotSmoothed() {
        ...
        let segments = [
            DiarizationSegmentRecord(speakerId: "S2", startMs: 0, endMs: 300),
            DiarizationSegmentRecord(speakerId: "S1", startMs: 300, endMs: 900),
            DiarizationSegmentRecord(speakerId: "S2", startMs: 900, endMs: 1200),
        ]
