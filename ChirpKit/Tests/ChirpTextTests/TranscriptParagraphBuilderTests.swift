// Ported from MacParakeet (GPL-3.0): Tests/MacParakeetTests/TextProcessing/TranscriptParagraphBuilderTests.swift @ bbae9e0e
// Changes: `WordTimestamp` comes from ChirpCore; otherwise unchanged.
