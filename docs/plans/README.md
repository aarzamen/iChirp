...
| [003](2026-09-22-003-feat-m0-m1-implementation-plan.md) | M0 + M1 implementation plan (Tasks 1–14) | **IN PROGRESS** | Its final task flips this row, [`spec/README.md#milestones`](../../spec/README.md#milestones) and the root [`README.md`](../../README.md#status) status table to IMPLEMENTED together, with the SHA and what was verified |
