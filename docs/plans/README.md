...
| [016](2026-09-22-016-m7-engine-breadth.md) | M7: engine breadth and benchmarks | **IN PROGRESS** | Step 5 (llama.cpp small models, ADR-015) built and Mac-measured on `lane/on-device-llm`; phone numbers pending ([research](../research/2026-09-22-on-device-llm.md)) |
