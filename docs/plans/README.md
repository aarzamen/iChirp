...
| [003](2026-09-22-003-feat-m0-m1-implementation-plan.md) | M0 + M1 implementation plan (Tasks 1–14) | **IN PROGRESS** | Its final task updates this row and [`spec/README.md#milestones`](../../spec/README.md#milestones) with the SHA and what was verified |
