...
| [013](2026-09-22-013-m4-language-models-and-deliverables.md) | M4: language models and deliverables | **IN PROGRESS** — Steps 1–5 (engines, Keychain keys, provider settings, routing with per-run overrides, templates, deliverables, ledger, map-reduce) on `m4/language-models-core`, focused tests green, lint clean; ADR-011 | Step 6 UI lane (after M1.5): screens, Info.plist local-network keys, `project.yml` products, app-hosted Keychain test, device QA |
