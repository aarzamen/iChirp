...
| M7 | Engine breadth and on-device benchmarks: Apple SpeechTranscriber, WhisperKit, streaming Parakeet/Nemotron, MLX and llama.cpp | IN PROGRESS: the ASR lane has built routes, Apple Speech, WhisperKit and the benchmark (iPhone checks pending); streaming and small language models not yet | [016](../docs/plans/2026-09-22-016-m7-engine-breadth.md) |
