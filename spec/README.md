...
| M6 | Structure models: Needle 3 (from needle-rs source, ADR-012), Jev (opt-in, non-clinical), Laya research; confidence gating | IN PROGRESS — Needle slice built on `lane/needle` (SOAP fields and medications, voice commands, gate + evidence ledger, Eval; Needle experimental at 44.6% argument accuracy); Jev is plan 021 | [015](../docs/plans/2026-09-22-015-m6-structure-models.md) |
