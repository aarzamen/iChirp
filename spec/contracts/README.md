...
- [Decision Model Plug-in v1](decision-model-plugin-v1.md): `DecisionModel` (typed choice questions with calibrated
  probabilities), answer validation, the `decision` ledger feature and the clinical block (M6a, Jev).
